...
class QueryTest < Minitest::Test
  ...
  def test_order_by
    query = QueryKit::Query.new('users').order_by('name', 'ASC')
    assert_equal 'SELECT * FROM users ORDER BY name ASC', query.to_sql
  end

  def test_order_by_desc
    query = QueryKit::Query.new('users').order_by_desc('created_at')
  ...
  def test_group_by_multiple
    query = QueryKit::Query.new('orders').group_by('country', 'city')
